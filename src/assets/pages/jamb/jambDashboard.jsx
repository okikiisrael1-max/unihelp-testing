...
const DailyChallengeBanner = () => {
  return (
    <section className="mb-7 overflow-hidden rounded-3xl bg-gradient-to-r from-indigo-600 via-sky-600 to-emerald-500 text-white shadow-xl shadow-indigo-500/15">
        ...
        <div className="flex min-w-0 flex-col gap-4 sm:flex-row sm:items-center">
          ...
          <div className="min-w-0">
            ...
            <h2 className="max-w-3xl text-xl font-black leading-tight sm:text-2xl lg:text-3xl">
              Take today's challenge before your next mock.
            </h2>

            <p className="mt-2 max-w-2xl text-sm leading-6 text-white/85">
              Build speed, earn XP, and keep your JAMB preparation streak moving.
            </p>

            <div className="mt-4 grid grid-cols-3 gap-2 sm:flex sm:flex-wrap">
              {["8 Questions", "Timed Mode", "XP Reward"].map((item) => (
